...
Source: "..\..\TARGET_TREES\ehs_env-linux_x86_gtk_gst\*"; DestDir: "{app}\EHS\ehs_env-linux_x86_gtk_gst\"; Flags: recursesubdirs createallsubdirs ignoreversion;
...
Root: HKCR; Subkey: "inxware linux executable"; ValueType: string; ValueName: ""; ValueData: "inxware executable"; Flags: uninsdeletekey
;;Root: HKCR; Subkey: "inxware linux executable\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\EHS\ehs_env-linux_x86_gtk_gst\bin\run_ehs.sh,0"; Flags: uninsdeletekey
Root: HKCR; Subkey: "inxware linux executable\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\EHS\ehs_env-linux_x86_gtk_gst\bin\run_ehs.sh NO_RESTART"" ""%1"""; Flags: uninsdeletekey
;;;Root: HKLM; Subkey: "SYSTEM\CurrentControlSet\Control\Session Manager\Environment";ValueType: expandsz; ValueName: "Path"; ValueData: "{olddata};{app}\bin\cslib";Check: NeedsAddPath('{app}\bin\cslib')
...
[Icons]
;;Name: "{group}\inxware\ehs"; Filename: "{app}\bin\ehs.exe"; WorkingDir: {app}\bin
