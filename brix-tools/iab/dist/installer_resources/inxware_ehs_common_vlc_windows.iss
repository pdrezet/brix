...
Source: "..\..\TARGET_TREES\ehs_env-win_x86_gtk\*"; DestDir: "{app}\EHS\ehs_env-win_x86_gtk\"; Flags: recursesubdirs createallsubdirs ignoreversion;
...
Root: HKCR; Subkey: "inxware executable\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\EHS\ehs_env-win_x86_gtk\bin\ehs.exe,0"; Flags: uninsdeletekey
Root: HKCR; Subkey: "inxware executable\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\EHS\ehs_env-win_x86_gtk\bin\ehs.exe"" ""%1"""; Flags: uninsdeletekey
Root: HKLM; Subkey: "SYSTEM\CurrentControlSet\Control\Session Manager\Environment";ValueType: expandsz; ValueName: "Path"; ValueData: "{olddata};{app}\EHS\ehs_env-win_x86_gtk\bin\cslib";Check: NeedsAddPath('{app}\EHS\ehs_env-win_x86_gtk\bin\cslib')
...
[Icons]
Name: "{group}\inxware\ehs"; Filename: "{app}\EHS\ehs_env-win_x86_gtk\bin\ehs.exe"; WorkingDir: "{app}\EHS\ehs_env-win_x86_gtk\bin";
