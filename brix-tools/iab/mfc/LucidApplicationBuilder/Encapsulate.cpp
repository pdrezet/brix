...
Encapsulate::Encapsulate(INXObjList* _encapsulated, CWnd* pParent /*=NULL*/)
	: CDialog(Encapsulate::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(Encapsulate, CDialog)
	//{{AFX_MSG_MAP(Encapsulate)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
BOOL Encapsulate::OnInitDialog() 
{
	...
	CFont *m_Font = m_ctlMenuName.GetFont();
