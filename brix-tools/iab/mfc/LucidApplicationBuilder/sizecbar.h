...
protected:
    ...
    BOOL GetEdgeRect(INXRect rcWnd, UINT nHitTest, INXRect& rcEdge);
    virtual void StartTracking(UINT nHitTest, INXPoint point);
    virtual void StopTracking();
    virtual void OnTrackUpdateSize(INXPoint& point);
...
protected:
    ...
    afx_msg void OnNcLButtonDown(UINT nHitTest, CPoint _point);
    afx_msg void OnLButtonDown(UINT nFlags, CPoint _point);
    afx_msg void OnLButtonDblClk(UINT nFlags, CPoint _point);
...
// Drag Operations
    virtual void StartDrag(INXPoint pt);
};
...
public:
    ...
    afx_msg void OnNcLButtonDown(UINT nHitTest, INXPoint point);
