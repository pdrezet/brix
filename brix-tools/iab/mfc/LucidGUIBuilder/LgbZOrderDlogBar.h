...
*/
class LgbZOrderDlogBar : public CDialogBar
{
	
	DECLARE_DYNAMIC(LgbZOrderDlogBar)

public:	
	LgbZOrderDlogBar(	CWnd* pParent = NULL);  //!< standard constructor
	virtual ~LgbZOrderDlogBar();				//!< standard destructor
	//static LgbZOrderDlogBar *c_pDlog;			//!< Ptr to the 1 and only instance

	//static LgbZOrderDlogBar *getLgbZOrderDlogBar( CWnd* pParent = NULL );
...
public: 
	...
	void childAdjustmentCompleted( CScrollBar* pScrollBar );
