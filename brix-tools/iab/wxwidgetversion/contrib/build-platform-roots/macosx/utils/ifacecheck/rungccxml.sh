...
cd ../../../../wxWidgets-3.0.3/include              # go to wx include folder
...
wx_top_builddir="/Users/pierredrezet/workspace/INX/brix/brix-tools/iab/wxwidgetversion/contrib/build-platform-roots/macosx"
top_srcdir="../../../../wxWidgets-3.0.3"
flags="-D_FILE_OFFSET_BITS=64 -I${wx_top_builddir}/lib/wx/include/osx_cocoa-ansi-3.0 -I${top_srcdir}/include -DWX_PRECOMP -g -O0 -fno-common -fvisibility=hidden -fvisibility-inlines-hidden"
...
flags="-I . -I ../../../../wxWidgets-3.0.3/include $flags -D__WXDEBUG__ -D__WXOSX_COCOA__ -DWXBUILDING $allheaders"
